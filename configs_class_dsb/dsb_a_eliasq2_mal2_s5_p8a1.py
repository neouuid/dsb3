# like dsb_eliasq1_mal2_s5_p8a1, but histogram eq for both tf learned arch and the final stage arch 
...
restart_from_save = '/home/eavsteen/dsb3/storage/metadata/dsb3//models/eavsteen/dsb_a_eliasq2_mal2_s5_p8a1-20170405-013328.pkl'
...
rescale_params_hist_eq = utils.load_pkl( "dsb_rescale_params_hist_eq.pkl" )

def data_prep_function(data, pid, patch_centers, pixel_spacing, p_transform,
...
def load_pretrained_model(l_in):
    ...
    metadata = utils.load_pkl(os.path.join("/home/eavsteen/dsb3/storage/metadata/dsb3/models/eavsteen/","r_elias_malignancy_2-20170402-185907.pkl"))
