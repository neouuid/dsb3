...
def build_model():
    ...
    l_in_patch_locs = nn.layers.InputLayer((None, n_candidates_per_patient, 3))
    ...
    l = drop(penultimate_layer, name='drop_final1')
    ...
    return namedtuple('Model', ['l_in', 'l_in_patch_locs', 'l_out', 'l_target'])(l_in, l_in_patch_locs, l_out, l_target)
