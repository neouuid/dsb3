...
def load_pretrained_model(l_in):
    ...
    l_out = nn.layers.DenseLayer(l, num_units=5,
                                 W=nn.init.Orthogonal(),
                                 b=nn.init.Constant(0.1),
                                 nonlinearity=nn.nonlinearities.softmax)


    metadata = utils.load_pkl(os.path.join("/home/eavsteen/dsb3/storage/metadata/dsb3/models/eavsteen/","t_el_6-20170324-021750.pkl"))
...
def build_model():
    ...
    l = drop(penultimate_layer, name='drop_final', p=0.2)
